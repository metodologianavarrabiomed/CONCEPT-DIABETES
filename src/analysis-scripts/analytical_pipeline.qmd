...
def select_by_condition(cond):
    ...
    '''
    cmbd_df_path = '../../outputs/dm_cmbd_df.csv'
    comorb_df_path = '../../outputs/dm_comorb_df.csv'
    param_df_path = '../../outputs/dm_param_df.csv'
    patients_df_path = '../../outputs/dm_patients_df.csv'
    treat_df_path = '../../outputs/dm_treat_df.csv'
    
    con = duckdb.connect('../../inputs/data.duckdb')
    cmbd_df = con.sql("SELECT * from main.cmbd").df()
    comorb_df = con.sql("SELECT * from main.comorb").df()
    param_df = con.sql("SELECT * from main.param").df()
    patients_df = con.sql("SELECT * from main.patient").df()
    treat_df = con.sql("SELECT * from main.treat").df()
...
png(filename=gsub("src/analysis-scripts/","",
                  here("outputs","activity_presence.png")),
...
process_map_by_cluster(load_csv_log(gsub("src/analysis-scripts/","",
                                    here("outputs","eventlog_filtered.csv"))),
                       0.25)
```

::: {#fig-cluster0 .column-page layout-ncol="2"}
...
::: {#fig-cluster2 .column-page layout-ncol="2"}
...
![Process map covering 25% most frequent traces](../../outputs/evlog_pm_cluster_3.png){#fig-processmap3}

Cluster 3
:::

::: {#fig-cluster4 .column-page layout-ncol="2"}
![5 most frequent traces](../../outputs/trace_4.png){#fig-traceexplorer4}

![Process map covering 25% most frequent traces](../../outputs/evlog_pm_cluster_4.png){#fig-processmap4}

Cluster 4
:::

::: {#fig-cluster5 .column-page layout-ncol="2"}
...
::: {#fig-cluster6 .column-page layout-ncol="2"}
![5 most frequent traces](../../outputs/trace_6.png){#fig-traceexplorer6}

![Process map covering 25% most frequent traces](../../outputs/evlog_pm_cluster_6.png){#fig-processmap6}

Cluster 6
:::

::: {#fig-cluster8 .column-page layout-ncol="2"}
...
::: {#fig-cluster10 .column-page layout-ncol="2"}
![5 most frequent traces](../../outputs/trace_10.png){#fig-traceexplorer10}

![Process map covering 25% most frequent traces](../../outputs/evlog_pm_cluster_10.png){#fig-processmap10}

Cluster 10
:::

::: {#fig-cluster11 .column-page layout-ncol="2"}
...
In @fig-decision_tree is shown how patients' age, sex and copayment would influence in prescribing three drugs based treatment. More features could have been added but for simplicity we included those three.
...
df_fitness <- read.csv(gsub("src/analysis-scripts/","",
                            here("outputs","fitness_by_cluster.csv")))
df_patient <- read.csv(gsub("src/analysis-scripts/","",
                            here("outputs","dm_patients_df.csv")))
