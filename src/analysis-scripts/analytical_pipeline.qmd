...
con.sql("select patient_id as person,STRING_AGG(health_service, ',' order by visit_date) as trace,\
             ...
             when visit_type==1 and visit_loc==1 and visit_service=='APA' then 'general_practitioner_visit' \
             when visit_type==1 and visit_loc==2 and visit_service=='APA' then 'general_practitioner_visit_home_visit' \
             when visit_type==2 and visit_loc==1 and visit_service=='APA' then 'nurse_visit_first_visit' \
             when visit_type==2 and visit_loc==2 and visit_service=='APA' then 'nurse_visit_home_visit' \
             when visit_type==4 and visit_service=='APA' then 'accident_&_emergency_visit_health_center' \
             when visit_service=='CAR' then 'cardiology_visit' \
             when visit_service=='ALG' then 'allergology_visit' \
             when visit_service=='APR' then 'pathological_anatomy_visit' \
